...
<!DOCTYPE html> 		
						...
						<div class="doctor-widget">
							<div class="doc-info-left">
								<div class="doctor-img">
									<img src="${path}/resources/assets/img/doctors/doctor-thumb-02.jpg" class="img-fluid" alt="User Image">
								</div>
								<div class="doc-info-cont">
									<h4 class="doc-name">Dr. Darren Elder</h4>
									<p class="doc-speciality">BDS, MDS - Oral & Maxillofacial Surgery</p>
									<p class="doc-department"><img src="${path}/resources/assets/img/specialities/specialities-05.png" class="img-fluid" alt="Speciality">Dentist</p>
									<div class="rating">
									...
									<div class="clinic-details">
										...
										<ul class="clinic-gallery">
											<li>
												<a href="${path}/resources/assets/img/features/feature-01.jpg" data-fancybox="gallery">
													<img src="${path}/resources/assets/img/features/feature-01.jpg" alt="Feature">
												</a>
											</li>
											<li>
												<a href="${path}/resources/assets/img/features/feature-02.jpg" data-fancybox="gallery">
													<img  src="${path}/resources/assets/img/features/feature-02.jpg" alt="Feature Image">
												</a>
											</li>
											<li>
												<a href="${path}/resources/assets/img/features/feature-03.jpg" data-fancybox="gallery">
													<img src="${path}/resources/assets/img/features/feature-03.jpg" alt="Feature">
												</a>
											</li>
											<li>
												<a href="${path}/resources/assets/img/features/feature-04.jpg" data-fancybox="gallery">
													<img src="${path}/resources/assets/img/features/feature-04.jpg" alt="Feature">
												</a>
											</li>
										</ul>
									</div>
										...
										<div class="col-md-6">
											<div class="clinic-content">
												...
												<div class="clinic-details mb-0">
													...
													<ul>
														<li>
															<a href="${path}/resources/assets/img/features/feature-01.jpg" data-fancybox="gallery2">
																<img src="${path}/resources/assets/img/features/feature-01.jpg" alt="Feature Image">
															</a>
														</li>
														<li>
															<a href="${path}/resources/assets/img/features/feature-02.jpg" data-fancybox="gallery2">
																<img src="${path}/resources/assets/img/features/feature-02.jpg" alt="Feature Image">
															</a>
														</li>
														<li>
															<a href="${path}/resources/assets/img/features/feature-03.jpg" data-fancybox="gallery2">
																<img src="${path}/resources/assets/img/features/feature-03.jpg" alt="Feature Image">
															</a>
														</li>
														<li>
															<a href="${path}/resources/assets/img/features/feature-04.jpg" data-fancybox="gallery2">
																<img src="${path}/resources/assets/img/features/feature-04.jpg" alt="Feature Image">
															</a>
														</li>
													</ul>
												</div>
							...
							<div role="tabpanel" id="doc_reviews" class="tab-pane fade">
								...
								<div class="write-review">
									...
									<form action="addReview.do" method="post">
										<input type="hidden" name="patient_num" value="${sessionScope.patient_num}" />
										<input type="hidden" name="doctor_num" value="${doctor_num}" />
										...
										<div class="form-group">
											<label>리뷰 작성하기</label>
											<textarea id="review_desc" name="review_content" maxlength="100" class="form-control"></textarea>
					...
					<div class="call-box incoming-box">
						<div class="call-wrapper">
							<div class="call-inner">
								<div class="call-user">
									<img alt="User Image" src="${path}/resources/assets/img/doctors/doctor-thumb-02.jpg" class="call-avatar">
				...
				<div class="modal-body">
					...
					<div class="call-box incoming-box">
						<div class="call-wrapper">
							<div class="call-inner">
								<div class="call-user">
									<img class="call-avatar" src="${path}/resources/assets/img/doctors/doctor-thumb-02.jpg" alt="User Image">
									<h4>Dr. Darren Elder</h4>
									<span>Calling ...</span>
								</div>							
								<div class="call-items">
	...
	<!-- Video Call Modal -->
		...
		<!-- Fancybox JS -->
		<script src="${path}/resources/assets/plugins/fancybox/jquery.fancybox.min.js"></script>
