				    ...
				    var jumins3 = $("#p_jumin_num").val();
				      ...
				      if (!fmt.test(jumins3)) {
				        ...
				        //남 여 구분
				        	...
				        	document.userInsert.p_gender.value="남";
							$("#jumin_check").text("주민번호가 일치합니다.");
							$('#jumin_check').css('color', 'green');

					   }else{
				        	document.userInsert.p_gender.value="여";
						...
						<div class="col-md-7 col-lg-8 col-xl-9" style="margin:auto;">
							<div class="card">
								<div class="card-body">
									...
									<form action="userInsert" name="userInsert" method="post" enctype="multipart/form-data" onsubmit="return checks()"> <!-- onsubmit="return checks() -->
										<div class="row form-row">
													...
													<div class="change-avatar">
														...
														<div class="upload-img">
															<div class="change-photo-btn">
																...
																<input type="file" class="upload" id="p_photo" name="file" onchange="readURL(this);">
															</div>
											...
											<div class="col-6">
												...
												<input id="p_phone_num" name="p_phone_num" class="form-control" maxlength="11" size="40" value="" type="text" placeholder="'-' 없이 번호만 입력해주세요.">
											...
											<div class="col-6">
												...
												<div class="btn-group btn-group-toggle" data-toggle="buttons">
													<label class="btn btn-primary">
														<input type="radio" name="allergy" id="allergy" value="유"> 있음
													</label>
													<label class="btn btn-primary">
														<input type="radio" name="allergy" id="allergy" value="무"> 없음
													</label>
												</div>
												
												<div class="check_font" id="allergy_check"></div>
												</div>
											</div>
											<div class="col-12 ">
